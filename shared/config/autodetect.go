...
// detectNodeRuntime reads package.json and extracts Node.js version.
func detectNodeRuntime(packageJSONPath string) (string, string) {
	...
	if pkg.Engines.Node != "" {
		// Parse version like "^18.0.0" or ">=18"
	...
	return "node", "18" // Default to Node 18
}

// importDockerCompose imports services from docker-compose.yml.
